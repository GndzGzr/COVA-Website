    ...
    <main className="relative min-h-screen w-full snap-y snap-mandatory overflow-y-scroll scroll-smooth">
      ...
      <section className="relative z-10 min-h-screen w-full flex items-center justify-center py-16 sm:py-20 px-2 sm:px-4 md:px-6 lg:px-8 snap-start" data-state="active">
        <div className="max-w-4xl w-full">
          <div className="bg-black/40 backdrop-blur-sm rounded-lg sm:rounded-2xl shadow-2xl p-4 sm:p-6 md:p-8 lg:p-12 text-white">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-8 sm:mb-12 text-center bg-gradient-to-r from-amber-500 via-orange-400 via-30% via-red-400 via-60% via-rose-300 via-80% to-orange-200 text-transparent bg-clip-text animate-gradient">
              Future Work & Vision
            </h1>
            
            <div className="space-y-6 sm:space-y-8 text-base sm:text-lg leading-relaxed">
              <div className="bg-purple-900/30 backdrop-blur-sm rounded-lg sm:rounded-xl p-4 sm:p-6 border border-purple-500/30">
                <h2 className="text-xl sm:text-2xl font-semibold text-purple-300 mb-3 sm:mb-4">
                  Current Impact
                </h2>
                <p className="text-sm sm:text-base text-gray-200 max-w-prose">
              ...
              <div className="bg-blue-900/30 backdrop-blur-sm rounded-lg sm:rounded-xl p-4 sm:p-6 border border-blue-500/30">
                <h2 className="text-xl sm:text-2xl font-semibold text-blue-300 mb-3 sm:mb-4">
              ...
              <div className="bg-emerald-900/30 backdrop-blur-sm rounded-lg sm:rounded-xl p-4 sm:p-6 border border-emerald-500/30">
              ...
              <div className="bg-amber-900/30 backdrop-blur-sm rounded-lg sm:rounded-xl p-4 sm:p-6 border border-amber-500/30">
              ...
              <div className="bg-rose-900/30 backdrop-blur-sm rounded-lg sm:rounded-xl p-4 sm:p-6 border border-rose-500/30">
              ...
              <div className="mt-6 sm:mt-8 p-4 sm:p-6 border-t border-white/20">
                <p className="text-sm sm:text-base text-gray-200 italic text-center max-w-prose mx-auto">
